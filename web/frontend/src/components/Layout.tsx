    ...
    <div className="flex h-screen bg-app-bg">
      ...
      >
        ...
        <div
          ...
          style={{ height: 52, padding: collapsed ? '0 12px' : '0 12px', gap: 10 }}
        >
          <Link
            to="/dashboard"
            className="w-9 h-9 rounded-lg bg-primary flex items-center justify-center flex-shrink-0 no-underline"
            title="Dashboard"
          >
            <LogoMark />
          </Link>
          ...
          {!collapsed && (
            <>
              <span className="flex-1 text-base font-semibold text-ink whitespace-nowrap overflow-hidden leading-none">
                Insightor
              </span>
              <button
        ...
        <div className="flex-shrink-0 border-t border-border" style={{ padding: '6px' }}>
          {collapsed ? (
            <div className="flex flex-col items-center gap-1.5 py-0.5">
              <div
                className="w-8 h-8 rounded-md bg-primary flex items-center justify-center text-sm font-semibold text-white cursor-default"
                title={user?.username}
              >
                {initials}
              </div>
            ...
            <div className="flex items-center gap-3 px-2 py-1.5">
              ...
              <div className="flex-1 min-w-0 overflow-hidden">
                <p className="text-sm font-medium text-ink whitespace-nowrap overflow-hidden text-ellipsis leading-snug">
                  {user?.username}
                </p>
